...
# description: script that generates the fourth plot of
...
# We create a 2x2 grid for plotting the results
par(mfrow=c(2,2))
# We plot the Active Power.
plot(x=hpc_filtered$DateTime, y=hpc_filtered[,"Global_active_power"],type="l",xlab="", ylab="Global Active Power")
# We plot the Voltage.
plot(x=hpc_filtered$DateTime, y=hpc_filtered[,"Voltage"],type="l",xlab="datetime", ylab="Voltage")
# We plot the third graph.
...
# We plot the Reactive Power.
plot(x=hpc_filtered$DateTime, y=hpc_filtered[,"Global_reactive_power"],type="l",xlab="datetime", ylab="Global_reactive_power")
